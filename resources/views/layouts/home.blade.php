...
<head>
    ...
    <link href="{{ asset('css/error-success.css') }}" rel="stylesheet">
</head>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small>Grand-Bazar,Trim-Trim, Nampula</small>
                </div>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        <a href="{{ route('recursos') }}" class="dropdown-item">Recursos</a>
                        <a href="{{ route('home-medicos') }}" class="dropdown-item">Nossos médicos</a>
                        <a href="{{ route('agendar') }}" class="dropdown-item">Agendar</a>
                    </div>
                </div>
                <a href="{{ route('contactar') }}" class="nav-item nav-link">Contact</a>
            </div>
            <a href="{{ route('agendar') }}" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Agendar<i
